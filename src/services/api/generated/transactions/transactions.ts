...
/**
 * Crea una entrada completa al almacén en una sola transacción:
...
3. Genera el PDF automáticamente (opcional)
...
- Actualización automática del peso en inventario
...
```json
{
  ...
  "authorized_by": "Juan Pérez",
  "received_by": "María López",
  "items": [
    {
      "inventory_id": 1,
...
export const useCreateCompleteInbound = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationReturnType<
    ...
    /**
 * Crea una salida completa del almacén en una sola transacción:
...
- Validación de peso disponible antes de crear la salida
- Actualización automática del peso en inventario
